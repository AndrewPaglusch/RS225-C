...
void rsaenc(Packet *packet, const char *mod, const char *exp) {
     ...
     * ignored unless being used to indicate the MSB for sign. since the byte
     * array lengths range from 63-65 and always want a positive integer,
     * make result_length 65 and begin with up to two 0 bytes */
